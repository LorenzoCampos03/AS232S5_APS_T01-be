...
public class QuoteController {
    ...
    // 🔹 Listar todas las inactivas
    @GetMapping("/inactivas")
    public Flux<Quote> getInactiveQuotes() {
        System.out.println("🔍 Endpoint /inactivas llamado");
        return quoteService.getAllInactiveQuotes()
                .doOnNext(quote -> System.out.println("📦 Quote inactivo encontrado: ID=" + quote.getId() + ", Status=" + quote.getStatus()))
                .doOnComplete(() -> System.out.println("✅ Flux completado"));
    }
